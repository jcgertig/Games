...
const CATALOG: AssetDef[] = [
  ...
  // ── Farm Items ───────────────────────────────────────────────────────────────
  { id:"farm_acorn",                   label:"Acorn",                    category:"Farm Items", path:`${NH}/farm/items/acorn.png`,                    scale:1 },
  { id:"farm_apple_green",             label:"Green Apple",              category:"Farm Items", path:`${NH}/farm/items/apple_green.png`,              scale:1 },
  { id:"farm_banana_1",                label:"Banana",                   category:"Farm Items", path:`${NH}/farm/items/banana_1.png`,                 scale:1 },
  { id:"farm_banana_2",                label:"Banana 2",                 category:"Farm Items", path:`${NH}/farm/items/banana_2.png`,                 scale:1 },
  { id:"farm_banana_3",                label:"Banana 3",                 category:"Farm Items", path:`${NH}/farm/items/banana_3.png`,                 scale:1 },
  { id:"farm_banana_bundle",           label:"Banana Bundle",            category:"Farm Items", path:`${NH}/farm/items/banana_bundle.png`,            scale:1 },
  { id:"farm_basket_apples",           label:"Basket of Apples",         category:"Farm Items", path:`${NH}/farm/items/basket_apples.png`,            scale:1 },
  { id:"farm_basket_bananas",          label:"Basket of Bananas",        category:"Farm Items", path:`${NH}/farm/items/basket_bananas.png`,           scale:1 },
  { id:"farm_basket_blueberries",      label:"Basket of Blueberries",    category:"Farm Items", path:`${NH}/farm/items/basket_blueberries.png`,       scale:1 },
  { id:"farm_basket_cantaloupe",       label:"Basket of Cantaloupe",     category:"Farm Items", path:`${NH}/farm/items/basket_cantaloupe.png`,        scale:1 },
  { id:"farm_basket_cherries",         label:"Basket of Cherries",       category:"Farm Items", path:`${NH}/farm/items/basket_cherries.png`,          scale:1 },
  { id:"farm_basket_corn",             label:"Basket of Corn",           category:"Farm Items", path:`${NH}/farm/items/basket_corn.png`,              scale:1 },
  { id:"farm_basket_garlic",           label:"Basket of Garlic",         category:"Farm Items", path:`${NH}/farm/items/basket_garlic.png`,            scale:1 },
  { id:"farm_basket_grapes",           label:"Basket of Grapes",         category:"Farm Items", path:`${NH}/farm/items/basket_grapes.png`,            scale:1 },
  { id:"farm_basket_green_beans",      label:"Basket of Green Beans",    category:"Farm Items", path:`${NH}/farm/items/basket_green_beans.png`,       scale:1 },
  { id:"farm_basket_greens",           label:"Basket of Greens",         category:"Farm Items", path:`${NH}/farm/items/basket_greens.png`,            scale:1 },
  { id:"farm_basket_mushrooms",        label:"Basket of Mushrooms",      category:"Farm Items", path:`${NH}/farm/items/basket_mushrooms.png`,         scale:1 },
  { id:"farm_basket_onions",           label:"Basket of Onions",         category:"Farm Items", path:`${NH}/farm/items/basket_onions.png`,            scale:1 },
  { id:"farm_basket_peaches",          label:"Basket of Peaches",        category:"Farm Items", path:`${NH}/farm/items/basket_peaches.png`,           scale:1 },
  { id:"farm_basket_pineapple_mix",    label:"Basket of Pineapple Mix",  category:"Farm Items", path:`${NH}/farm/items/basket_pineapple_mix.png`,     scale:1 },
  { id:"farm_basket_spinach",          label:"Basket of Spinach",        category:"Farm Items", path:`${NH}/farm/items/basket_spinach.png`,           scale:1 },
  { id:"farm_basket_squash",           label:"Basket of Squash",         category:"Farm Items", path:`${NH}/farm/items/basket_squash.png`,            scale:1 },
  { id:"farm_basket_strawberries",     label:"Basket of Strawberries",   category:"Farm Items", path:`${NH}/farm/items/basket_strawberries.png`,      scale:1 },
  { id:"farm_basket_truffles",         label:"Basket of Truffles",       category:"Farm Items", path:`${NH}/farm/items/basket_truffles.png`,          scale:1 },
  { id:"farm_blueberry_1",             label:"Blueberry",                category:"Farm Items", path:`${NH}/farm/items/blueberry_1.png`,              scale:1 },
  { id:"farm_cherry",                  label:"Cherry",                   category:"Farm Items", path:`${NH}/farm/items/cherry.png`,                   scale:1 },
  { id:"farm_chili_pepper_1",          label:"Chili Pepper",             category:"Farm Items", path:`${NH}/farm/items/chili_pepper_1.png`,           scale:1 },
  { id:"farm_chili_pepper_2",          label:"Chili Pepper 2",           category:"Farm Items", path:`${NH}/farm/items/chili_pepper_2.png`,           scale:1 },
  { id:"farm_coconut",                 label:"Coconut",                  category:"Farm Items", path:`${NH}/farm/items/coconut.png`,                  scale:1 },
  { id:"farm_cucumber_1",              label:"Cucumber",                 category:"Farm Items", path:`${NH}/farm/items/cucumber_1.png`,               scale:1 },
  { id:"farm_cucumber_row",            label:"Cucumber Row",             category:"Farm Items", path:`${NH}/farm/items/cucumber_row.png`,             scale:1 },
  { id:"farm_garlic_1",                label:"Garlic",                   category:"Farm Items", path:`${NH}/farm/items/garlic_1.png`,                 scale:1 },
  { id:"farm_garlic_2",                label:"Garlic 2",                 category:"Farm Items", path:`${NH}/farm/items/garlic_2.png`,                 scale:1 },
  { id:"farm_garlic_3",                label:"Garlic 3",                 category:"Farm Items", path:`${NH}/farm/items/garlic_3.png`,                 scale:1 },
  { id:"farm_garlic_4",                label:"Garlic 4",                 category:"Farm Items", path:`${NH}/farm/items/garlic_4.png`,                 scale:1 },
  { id:"farm_garlic_5",                label:"Garlic 5",                 category:"Farm Items", path:`${NH}/farm/items/garlic_5.png`,                 scale:1 },
  { id:"farm_golden_seeds",            label:"Golden Seeds",             category:"Farm Items", path:`${NH}/farm/items/golden_seeds.png`,             scale:1 },
  { id:"farm_grapes_1",                label:"Grapes",                   category:"Farm Items", path:`${NH}/farm/items/grapes_1.png`,                 scale:1 },
  { id:"farm_grapes_2",                label:"Grapes 2",                 category:"Farm Items", path:`${NH}/farm/items/grapes_2.png`,                 scale:1 },
  { id:"farm_green_bean_1",            label:"Green Bean",               category:"Farm Items", path:`${NH}/farm/items/green_bean_1.png`,             scale:1 },
  { id:"farm_green_bean_2",            label:"Green Bean 2",             category:"Farm Items", path:`${NH}/farm/items/green_bean_2.png`,             scale:1 },
  { id:"farm_green_stack",             label:"Green Stack",              category:"Farm Items", path:`${NH}/farm/items/green_stack.png`,              scale:1 },
  { id:"farm_herb",                    label:"Herb",                     category:"Farm Items", path:`${NH}/farm/items/herb.png`,                     scale:1 },
  { id:"farm_kale",                    label:"Kale",                     category:"Farm Items", path:`${NH}/farm/items/kale.png`,                     scale:1 },
  { id:"farm_lemon_1",                 label:"Lemon",                    category:"Farm Items", path:`${NH}/farm/items/lemon_1.png`,                  scale:1 },
  { id:"farm_lemon_2",                 label:"Lemon 2",                  category:"Farm Items", path:`${NH}/farm/items/lemon_2.png`,                  scale:1 },
  { id:"farm_lemon_3",                 label:"Lemon 3",                  category:"Farm Items", path:`${NH}/farm/items/lemon_3.png`,                  scale:1 },
  { id:"farm_lemon_4",                 label:"Lemon 4",                  category:"Farm Items", path:`${NH}/farm/items/lemon_4.png`,                  scale:1 },
  { id:"farm_lemon_large",             label:"Large Lemon",              category:"Farm Items", path:`${NH}/farm/items/lemon_large.png`,              scale:1 },
  { id:"farm_market_banana_tomato",    label:"Market: Banana & Tomato",  category:"Farm Items", path:`${NH}/farm/items/market_banana_tomato_grapes.png`, scale:1 },
  { id:"farm_market_crates",           label:"Market: Crates",           category:"Farm Items", path:`${NH}/farm/items/market_crates_red_berries.png`,   scale:1 },
  { id:"farm_market_pineapple",        label:"Market: Pineapple Display",category:"Farm Items", path:`${NH}/farm/items/market_pineapple_display.png`,    scale:1 },
  { id:"farm_market_truffle_corn",     label:"Market: Truffle & Corn",   category:"Farm Items", path:`${NH}/farm/items/market_truffle_corn_garlic.png`,  scale:1 },
  { id:"farm_mushroom_1",              label:"Mushroom",                 category:"Farm Items", path:`${NH}/farm/items/mushroom_1.png`,               scale:1 },
  { id:"farm_mushroom_2",              label:"Mushroom 2",               category:"Farm Items", path:`${NH}/farm/items/mushroom_2.png`,               scale:1 },
  { id:"farm_onion",                   label:"Onion",                    category:"Farm Items", path:`${NH}/farm/items/onion.png`,                    scale:1 },
  { id:"farm_orange",                  label:"Orange",                   category:"Farm Items", path:`${NH}/farm/items/orange.png`,                   scale:1 },
  { id:"farm_pineapple_1",             label:"Pineapple",                category:"Farm Items", path:`${NH}/farm/items/pineapple_1.png`,              scale:1 },
  { id:"farm_pineapple_2",             label:"Pineapple 2",              category:"Farm Items", path:`${NH}/farm/items/pineapple_2.png`,              scale:1 },
  { id:"farm_pineapple_3",             label:"Pineapple 3",              category:"Farm Items", path:`${NH}/farm/items/pineapple_3.png`,              scale:1 },
  { id:"farm_pineapple_trio_1",        label:"Pineapple Trio",           category:"Farm Items", path:`${NH}/farm/items/pineapple_trio_1.png`,         scale:1 },
  { id:"farm_pineapple_trio_2",        label:"Pineapple Trio 2",         category:"Farm Items", path:`${NH}/farm/items/pineapple_trio_2.png`,         scale:1 },
  { id:"farm_produce_crate_display",   label:"Produce Crate Display",    category:"Farm Items", path:`${NH}/farm/items/produce_crate_display.png`,    scale:1 },
  { id:"farm_seeds",                   label:"Seeds",                    category:"Farm Items", path:`${NH}/farm/items/seeds.png`,                    scale:1 },
  { id:"farm_spinach",                 label:"Spinach",                  category:"Farm Items", path:`${NH}/farm/items/spinach.png`,                  scale:1 },
  { id:"farm_tomato_1",                label:"Tomato",                   category:"Farm Items", path:`${NH}/farm/items/tomato_1.png`,                 scale:1 },
  { id:"farm_tomato_2",                label:"Tomato 2",                 category:"Farm Items", path:`${NH}/farm/items/tomato_2.png`,                 scale:1 },
  { id:"farm_truffle_1",               label:"Truffle",                  category:"Farm Items", path:`${NH}/farm/items/truffle_1.png`,                scale:1 },
  { id:"farm_truffle_2",               label:"Truffle 2",                category:"Farm Items", path:`${NH}/farm/items/truffle_2.png`,                scale:1 },
  { id:"farm_truffle_3",               label:"Truffle 3",                category:"Farm Items", path:`${NH}/farm/items/truffle_3.png`,                scale:1 },
  { id:"farm_yellow_seed",             label:"Yellow Seed",              category:"Farm Items", path:`${NH}/farm/items/yellow_seed.png`,              scale:1 },
];
